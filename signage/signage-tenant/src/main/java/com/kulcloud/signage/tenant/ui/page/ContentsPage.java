...
@Route(value = "contents", layout = MainView.class)
@PageView(title="Contents", icon="FILE_TEXT_O")
@PageTitle("Signage Contents")
public class ContentsPage extends ContentLayout {
